...
with title1 :
  ...
  st.write("Mise à jour du 08/05/2026 : Données rafraichies, modifications visuelles, liens cliquables sur la carte, colorisation des catégories (à vérifier / affiner)...")
